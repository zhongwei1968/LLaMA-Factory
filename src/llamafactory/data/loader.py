...
def _get_preprocessed_dataset(
    ...
    if training_args.should_log and os.getenv("PRINT_SAMPLE", "true") == "true":
        try:
...
def _get_merged_preprocessed_dataset(
    ...
    for dataset_attr in get_dataset_list(dataset_names, data_args.dataset_dir):
        ...
        dataset = _get_preprocessed_dataset(
                dataset, data_args, training_args, mix_stage, template, tokenizer, processor, is_eval
            )
...
def get_dataset(
    ...
    with training_args.main_process_first(desc="load dataset"):
        dataset = _get_merged_preprocessed_dataset(
           data_args.dataset, model_args, data_args, training_args, stage, template, tokenizer, processor, is_eval=False
        )

        eval_dataset = _get_merged_preprocessed_dataset(
           data_args.eval_dataset, model_args, data_args, training_args, stage, template, tokenizer, processor, is_eval=True
        )
